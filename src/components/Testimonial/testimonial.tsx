...
export const TestimonialsSection = ({
  ...
  return (
    <section className="w-full py-16 px-4 md:px-8 lg:px-16 bg-primary">
      <div className="mx-auto">
        {/* Left side - Header and Google Rating */}
        <div className="lg:col-span-5">
          <div className="flex flex-row gap-16 justify-between items-center">
            <div className="w-1/2">
              <p className="flex justify-end text-brand font-semibold text-xl tracking-wider mb-3 ">
                {label}
              </p>
            ...
            <div className="w-1/2">
              {description && (
                <p className="text-muted-foreground mb-8 text-lg">
                  {description.split("exceptional services").map((part, i) =>
                    i === 0 ? (
                      <span key={i}>
                        {part}
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center justify-center w-full mt-10">
            ...
            <div className="w-full md:w-1/3 flex flex-col justify-center items-center text-center">
              <h3 className="text-2xl font-bold text-text mb-2">EXCELLENT</h3>
